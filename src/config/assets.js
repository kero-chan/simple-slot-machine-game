export const ASSETS = {
  imagePaths: {
    ...
    tile_bawan: new URL('../assets/slotMachine/tiles/bamboo.png', import.meta.url).href,
    ...
    tile_liangsuo_gold: new URL('../assets/slotMachine/tiles/liangsuo_gold.jpg', import.meta.url).href,
