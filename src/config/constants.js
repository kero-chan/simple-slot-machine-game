export const CONFIG = {
  ...
  game: {
    ...
    freeSpinsPerScatter: 1,       // Number of free spins awarded when bonus is triggered
    ...
    maxBonusPerColumn: 5          // Maximum bonus tiles allowed per column in visible rows (increased for testing high spawn rates)
  },
  spawnRates: {
    bonusChance: 0.5,               // 25% chance for bonus tiles (increased for testing, normal: 0.03)
